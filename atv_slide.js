...
s.addText("$28.67", { x:0.55, y:2.65, w:5.5, h:1.1, fontFace:PP, fontSize:80, bold:true, color:CORAL, align:"center", isTextBox:true, margin:0 });
s.addText("AVERAGE TRANSACTION VALUE", { x:0.55, y:3.82, w:5.5, h:0.28, fontFace:PP, fontSize:10, color:GREY, align:"center", isTextBox:true, margin:0 });
s.addShape(p.ShapeType.rect, { x:1.3, y:4.28, w:4.0, h:0.03, fill:{ color:MUTED }, line:{ color:MUTED } });
s.addText("346 members returned", { x:0.55, y:4.42, w:5.5, h:0.32, fontFace:PP, fontSize:13, bold:true, color:WHITE, align:"center", isTextBox:true, margin:0 });
...
s.addText("$29.93", { x:7.28, y:2.65, w:5.5, h:1.1, fontFace:PP, fontSize:80, bold:true, color:WHITE, align:"center", isTextBox:true, margin:0 });
s.addText("AVERAGE TRANSACTION VALUE", { x:7.28, y:3.82, w:5.5, h:0.28, fontFace:PP, fontSize:10, color:GREY, align:"center", isTextBox:true, margin:0 });
s.addShape(p.ShapeType.rect, { x:8.03, y:4.28, w:4.0, h:0.03, fill:{ color:MUTED }, line:{ color:MUTED } });
s.addText("49 members returned", { x:7.28, y:4.42, w:5.5, h:0.32, fontFace:PP, fontSize:13, bold:true, color:WHITE, align:"center", isTextBox:true, margin:0 });
...
// ── Bottom callout ──
s.addText("DIFFERENCE: $1.26  ·  4.2%", { x:0.5, y:6.58, w:12.3, h:0.35, fontFace:PP, fontSize:14, bold:true, color:GREY, align:"center", isTextBox:true, margin:0 });
s.addText("Ads drove the decision to return — not basket size.", { x:0.5, y:6.98, w:12.3, h:0.3, fontFace:PP, fontSize:13, color:WHITE, align:"center", isTextBox:true, margin:0 });
